        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-cream-100 max-w-3xl mx-auto leading-relaxed">
              Whether you're looking to amplify your mission, engage your
              community, or build something entirely new—we're here to help.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-cream-100 mb-6">
                Have goals in mind? Let's discuss how we can partner to create
                lasting change.
              </p>
              <Button
                variant="primary"
            ...
            >
              ...
              <p className="text-cream-100 mb-6">
                See how we've helped organizations create meaningful systemic
                change.
              </p>
              <Button
                variant="outline"
                size="sm"
                className="w-full bg-transparent border-white text-white hover:bg-white hover:text-teal"
                href="/services"
              >
                View Services
              </Button>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-cream-100 text-sm leading-relaxed">
                Strategic consulting that creates equity, justice, and
                opportunity for all.
              </p>
            </div>
